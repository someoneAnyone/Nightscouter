...
//
class SessionDelegater: NSObject, WCSessionDelegate, ObservableObject {
    ...
    @Published var activationState: String = ""
    @Published var watchActivated: Bool = false
    
    @Published var currentCommandStatus: CommandStatus?
